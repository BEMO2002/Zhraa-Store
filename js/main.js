...
document.addEventListener("DOMContentLoaded", function () {
  ...
  function updateCartDisplay() {
    ...
    if (cartItems.length === 0) {
      cartItemsContainer.innerHTML =
        '<img src="/Assets/collection/cart-empty.png" alt="" class="w-[100px] mx-auto">';
      return;
    }
    // Calculate total
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  setupScrolling("container-mirror", "left-m", "right-m");
  setupScrolling("container-box", "left-b", "right-b");
});
